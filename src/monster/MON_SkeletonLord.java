...
public class MON_SkeletonLord extends Entity {
    ...
    public void getImage() {
        ...
        if(inRage) {
            ...
            down1 = setup("/monster/skeletonlord__phase2down_1", gp.tileSize * i, gp.tileSize * i);
    ...
    public void getAttackImage() {
        ...
        if(!inRage){
            ...
            attackLeft1 = setup("/monster/skeletonlord_attack_left_1", gp.tileSize * 2, gp.tileSize * i);
        ...
        if(inRage) {
            ...
            attackLeft1 = setup("/monster/skeletonlord_phase2_attack_left_1", gp.tileSize * 2, gp.tileSize * i);
